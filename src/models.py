...
#Currently trying Inpainting generator and discriminator to see if it has a better effect on d_loss
#Next step: define different generator architecture specific to dataset might work better or partially pretrained weights?
...
class Discriminator(BaseNetwork):
    def __init__(self, in_channels, use_sigmoid=True, use_spectral_norm=True, init_weights=True,gpu_ids = []):
