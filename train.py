...
## seemingly opt.ngf and ndf are legacy components, but they are not used either way, just changed to a string literal

## originally, passing a [0] in the last parameter, it would require cuda, regardless of you having it set up or not
gpu_id = []
if (opt.cuda):
    gpu_id = [0]
